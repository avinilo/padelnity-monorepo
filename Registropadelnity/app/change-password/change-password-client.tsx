...
const usePasswordForm = () => {
      ...
      await executeWithLoading(async () => {
        ...
        if (error) {
          ...
          if (errorMessage.includes('same password')) {
            toast.error("Misma contraseña", "La nueva contraseña debe ser diferente a la actual")
          } else if (errorMessage.includes('Password should be at least')) {
            toast.error("Contraseña muy débil", "Tu contraseña necesita ser más segura")
          } else {
            toast.error("No se pudo cambiar", "Inténtalo de nuevo en unos segundos")
          }
          return
        }
        
        // Éxito - mostrar mensaje y redirigir
        toast.success("¡Contraseña actualizada!", "Tu contraseña se ha cambiado exitosamente")
  ...
  }, [canSubmit, passwords.newPassword, updatePasswordSupabase, executeWithLoading, toast, router])
